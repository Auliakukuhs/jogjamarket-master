...
$sForm = [
	...
	'hideTitles'                  => '0',
	'title'                       => ('Jual Beli Barang Disekitarmu'),
	'subTitle'                    => ('Mudah, Cepat dan Efisien'),
						...
						<div class="row search-row fadeInUp">
							...
							<form id="seach" name="search" action="{{ lurl(trans('routes.v-search', $attr), $attr) }}" method="GET">
								<div class="col-lg-5 col-sm-5 search-col relative">
									...
									<input type="text" name="q" class="form-control keyword has-icon" placeholder="{{ ('Mau Cari Apa?') }}" value="">
								</div>
								<div class="col-lg-5 col-sm-5 search-col relative locationicon">
									...
									@if ($showMap)
										<input type="text" id="locSearch" name="location" class="form-control locinput input-rel searchtag-input has-icon tooltipHere"
											   placeholder="{{ ('Mau Cari Dimana?') }}" value="" title="" data-placement="bottom"
								...
								<div class="col-lg-2 col-sm-2 search-col">
									<button class="btn btn-primary btn-search btn-block">
										<i class="icon-search"></i> <strong>{{ ('Cari') }}</strong>
									</button>
								</div>
								{!! csrf_field() !!}
							</form>
